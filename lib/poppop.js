...
var PopPop = (function (_Component) {
  ...
  _createClass(PopPop, [{
    ...
    value: function render() {
      ...
      var wrapperStyle = Object.assign(_style2['default'].wrapper, _style2['default'][position]);
      ...
      if (overlay) {
        overlayTmpl = _react2['default'].createElement('div', { style: _style2['default'].overlay,
