...
var PopPop = (function (_Component) {
  ...
  _createClass(PopPop, [{
    ...
    value: function render() {
      ...
      if (position === 'full') contentStyle = Object.assign({}, _style2['default'].content, _style2['default'].full, backgroundStyle);else if (position === 'center') contentStyle = Object.assign({}, _style2['default'].content, _style2['default'].centerContent, backgroundStyle); // console.log(contentStyle)
